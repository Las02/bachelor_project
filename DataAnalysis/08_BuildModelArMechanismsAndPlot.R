...
# Format large list of drugs to only contain information from the list of unqiue drugs
...
dbListTables(conn)
# read in the information from ribdif
...
# add estimated marginal means to the dataframe for different values of genome components
